...
(function () {
    ...
    var LobiboxBase = {
        ...
        _createMarkup: function () {
            var me = this;
            var lobibox = $('<div class="lobibox" role="alert"></div>');
            lobibox.attr('data-is-modal', me.$options.modal);
            var header = $('<div class="lobibox-header"><div><div class="header-icon ' + (me.$type == 'success' ? 'header-icon-success' : me.$type == 'error' ? 'header-icon-error' : 'header-icon-warning') + '">' + (me.$type == 'success' ? '&#10003;' : me.$type == 'error' ? '&#735;' : '!') + '</div></div></div>')
                .append('<h2 class="lobibox-title" tabindex="0"></h2>')
            ;
        ...
        _addBackdrop: function () {
            if ($('.lobibox-backdrop').length === 0) {
                $('body').append('<div class="lobibox-backdrop"><iframe class="divfake" src="about:blank"></iframe></div>');
            }
        },
    ...
    LobiboxConfirm.prototype = $.extend({}, LobiboxBase, {
        ...
        _afterShow: function () {
            ...
            //    ;
            //}
            d.append('<div class="lobibox-body-text-wrapper"><span class="lobibox-body-text" tabindex="1">' + me.$options.msg + '</span></div>');
        ...
        me._init = function () {
            ...
            me.$el.on('click.lobibox', function (ev) {
                if (me.$options.onClickUrl) {
                    $app.ui.changeWindowLocation(me.$options.onClickUrl);
                }
